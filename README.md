...
- Linux x86_64 / aarch64 (glibc 2.35 or newer: Ubuntu 22.04+, Debian 12+, Fedora 36+; on older
  distributions, use `cargo install ziv`)
...
- **Release** (`.github/workflows/release.yml`): generated by cargo-dist from
  ...
  Linux and macOS binaries above, attaches the shell completions and man
